...
var VideoSeekSlider = (function (_super) {
    ...
    VideoSeekSlider.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "ui-video-seek-slider" },
            ...
            React.createElement("div", { className: this.isThumbActive() ? "hover-time active" : "hover-time", style: this.getHoverTimePosition(), ref: function (ref) { return _this.hoverTime = ref; } }, this.getHoverTime()),
